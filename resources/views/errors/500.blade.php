    ...
    <div class="container text-center">
        ...
        <div class="card m-5 rounded" style="height: 75vh;">
            <div class="card-header bg-dark">
                <h1 class="display-3 font-weight-bold headerText">
                    Ono!! A server error occurred! <br>
                    Error 500
                </h1>
            </div>
            <div class="card-body">
                <div class="row d-flex">
                    <h2 class="pl-5 m-0">Maybe these will work:</h2>
                </div>
                <div class="row center-row text-left p-5">
                    ...
                    <div class="col pr-5 text-right ">
                        <img class="img-fluid switch" style="width:25vw; height: auto;"
                             src="/assets/images/background/500.gif">
                    </div>
                </div>
            </div>
        </div>
